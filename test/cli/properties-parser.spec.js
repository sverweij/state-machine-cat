...
const parser = require('../../src/cli/properties-parser');
...
describe("#cli - properties-parser", () => {
    ...
    describe("happy day - multiple params", () => {
        it("two string params", () => {
            expect(parser.parse(" stringu= \"a string \" stringb = string")).to.deep.equal(
                [{"name": "stringu", "value": "a string "}, {"name": "stringb", "value": "string"}]
            );
        });
    });
