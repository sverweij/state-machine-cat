...
const makeValidEventNames = require('../../../src/render/scjson/makeValidEventNames');
...
describe('#makeValidEventNames', () => {
    ...
    it('replaces any space likes with a regular space', () => {
        checkExpectation('aap_noot_mies wim zus jet', 'aap\t\t\tnoot mies\nwim\n\n\rzus\rjet');
    });
    ...
    it('smoke test', () => {
        checkExpectation('3.little.小豬 有限._狀態機', '3.little.小豬\n有限.·狀態機\r\n');
    });
