...
const formatLabel = require("../../transform/utl.cjs").formatLabel;
const parserHelpers = require("../parser-helpers.cjs");
const normalizeMachine = require("./normalize-machine.cjs");
