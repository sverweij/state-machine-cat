...
return templates['HTMLTable.template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
    return "<th>"
  ...
  "<table>\n    <thead>\n        <th>"
    ...
    + "\n    </thead>\n    <tbody>\n";
  stack1 = ((helper = (helper = helpers.rows || (depth0 != null ? depth0.rows : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"rows","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
