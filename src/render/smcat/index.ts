/* eslint-disable node/global-require, @typescript-eslint/no-var-requires */
import type {
  IState,
  IStateMachine,
  ITransition,
...
/** the type definitions for Handlebars don't match what we're actually using - hence the cast to any */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const Handlebars = require("handlebars/dist/handlebars.runtime.js") as any;
...
module.exports = function renderSmcat(pStateMachine: IStateMachine): string {
